...
NameBot = (DevRio:get(BrandTame..'Rio:NameBot') or 'تركس')
--     Source BrandTame     --
...
if text and text:match('^'..(DevRio:get(BrandTame..'Rio:NameBot') or "تركس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(BrandTame..'Rio:NameBot') or "تركس")..' ','')
end
...
local BotName = (DevRio:get(BrandTame.."Rio:NameBot") or 'تركس')
...
if text and text == (DevRio:get(BrandTame..'Rio:NameBot') or 'تركس') then 
NameBot = (DevRio:get(BrandTame..'Rio:NameBot') or 'تركس')
...
DevRio:set(BrandTame..'Rio:NameBot',(DevRio:get(BrandTame..'Name:Bot') or 'تركس'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
